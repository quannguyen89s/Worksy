...
export const sendForgotPasswordEmail = async (to: string, forgotPasswordToken: string) => {
    ...
    const mailOptions = {
        from: `"Worksy" <${process.env.GMAIL_USER}>`,
        to,
        subject: "Reset your password - Worksy",
        html: `
<!DOCTYPE html>
<html>
<head>
        ...
        <tr>
            <td align="center">
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="text-align: center; padding: 30px 0 0;">
                            <div style="width: 70px; height: 70px; background: linear-gradient(135deg, #e67e22, #d35400); border-radius: 50%; margin: 0 auto; line-height: 70px; font-size: 32px;">
                                &#128274;
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 24px 48px 16px; text-align: center;">
                            <h2 style="color: #1a1a2e; margin: 0 0 12px; font-size: 22px; font-weight: 600;">Reset Your Password</h2>
                            <p style="color: #6b7280; font-size: 15px; line-height: 1.6; margin: 0;">
                    ...
                    <tr>
                        <td style="padding: 20px 48px; text-align: center;">
                            <p style="color: #9ca3af; font-size: 13px; margin: 0 0 8px;">If the button doesn't work, copy and paste this link:</p>
                            <p style="color: #2B4162; word-break: break-all; font-size: 12px; margin: 0; background: #f3f4f6; padding: 10px; border-radius: 6px;">${resetLink}</p>
                        </td>
                    </tr>
                    <!-- Expiry notice -->
                    <tr>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 24px 48px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="color: #9ca3af; font-size: 12px; margin: 0 0 4px;">If you didn't request a password reset, you can safely ignore this email.</p>
                            <p style="color: #d1d5db; font-size: 11px; margin: 0;">&copy; 2026 Worksy. All rights reserved.</p>
                        </td>
                    </tr>
                </table>
